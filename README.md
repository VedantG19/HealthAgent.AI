...
Primary Language: Python – The backbone for all AI logic and server-side processing.
API Framework: FastAPI – A high-performance, asynchronous framework used for handling user queries and system responses.
Database: SQLite – A lightweight relational database for storing user profiles, medication logs and chat history.

Frontend & UI

Library: React.js – A component-based JavaScript library for building a dynamic and responsive user interface.
Languages: JavaScript, HTML5 and CSS3 – Powering the interactive chat experience.
